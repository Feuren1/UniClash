...
class BattleForcedAdvancedTutorialViewModel(
    ...
    init {
        viewModelScope.launch {
            ...
            val playerTutorialCritter = CritterUsable(24, "Coolduck", 100, 70, 80, 50, listOfPlayerAttacks,1, 1,0,"NORMAL")
            ...
            val cpuAttack2 = Attack(2, "SuperGuard", 15, AttackType.DEF_BUFF,"NORMAL")
            ...
            val cpuTutorialCritter = CritterUsable(23, "Quizizzdragon", 130, 60, 115, 30, listOfCpuAttacks,1, 1,0,"NORMAL")
